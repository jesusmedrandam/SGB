...
| Sanidad, tratamientos, limpiezas y actividades | Medicamentos y jornadas sanitarias con borrador, aplicación y dosis incorporados; condiciones de salud, limpiezas y actividades pendientes | `src/modules/sanitary`, `health`, `cleanings`, `activities` |
