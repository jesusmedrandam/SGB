...
| Sanidad, tratamientos, limpiezas y actividades | Medicamentos, jornadas, condiciones, limpiezas y actividades de herraje y descorne incorporadas con historial; fotos pendientes | `src/modules/sanitary`, `health`, `cleanings`, `activities` |
...
| Agenda, notificaciones y panel de control | Pendientes; las tareas futuras y recordatorios son distintos de las actividades ya realizadas | `src/modules/agenda`, `notifications`, `dashboard` |
