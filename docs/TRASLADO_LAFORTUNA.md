...
| Sanidad, tratamientos, limpiezas y actividades | Medicamentos, jornadas, condiciones de salud y limpiezas con productos, operadores, área y consumos incorporados; actividades pendientes | `src/modules/sanitary`, `health`, `cleanings`, `activities` |
